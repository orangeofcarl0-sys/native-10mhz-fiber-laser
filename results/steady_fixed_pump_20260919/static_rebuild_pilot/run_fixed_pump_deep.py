...
label=best['support']
protocol=dict(support=label,linear_limit=240,linear_tolerance=.008,max_steps=30,rebuild_every=3,
...
for name,pump,parent in [('anchor',pump0,None),('down_275',.0275,'anchor'),('down_2725',.02725,'down_275'),
    ...
    x,h,status=solve_globalized(residual,initial,max_steps=30,radius=.05,rebuild_every=3,
        linear_limit=240,linear_tolerance=.008,stop_window=None,
